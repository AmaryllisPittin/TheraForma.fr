  ...
  return (
    <div>
      ...
      <section className='credo'>
        <div className='credo__h1'>
          <h1>Précisions utiles</h1>
        </div>
        <p className='credo__text'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quasi, totam distinctio, fugit laudantium laborum inventore dolorem perferendis quaerat reprehenderit pariatur perspiciatis rem a, dolore commodi dignissimos sapiente aperiam similique doloribus?</p>
        <div className='button-credo-container'>
          <p className='button-credo-container__text'>En savoir plus:</p>
