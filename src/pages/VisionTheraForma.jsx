    ...
    <div>
      ...
      <section className='vision-theraforma'>
        ...
        <p className='vision-theraforma__text'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat maiores animi earum voluptatibus quia. Totam quis consequuntur saepe voluptatibus voluptates sed corporis nemo enim porro cumque accusamus, molestiae, et possimus.</p>
          ...
          <div>
            <div className='vision-theraforma-lorem-texts'>
            <h3 className='vision-theraforma__h3'>Notre mission est fondée sur: </h3>
              <p className='vision-theraforma-lorem-texts__lorem-text'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur error nulla minima ratione architecto at sed id suscipit iste aspernatur dignissimos harum, vitae voluptatum, eveniet sit aperiam, debitis doloremque voluptates.</p>
              <p className='vision-theraforma-lorem-texts__lorem-text'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Qui excepturi quasi eum saepe expedita eligendi? Ipsa, eveniet? Tempore nobis laudantium itaque sequi nisi distinctio quis sint rem, corrupti velit tempora.</p>
              <p className='vision-theraforma-lorem-texts__lorem-text'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita atque voluptatibus numquam iste aliquid, eaque odit mollitia eligendi nostrum exercitationem. Vel et facilis quae. Optio temporibus eaque laborum dolorem perferendis!</p>
              <p className='vision-theraforma-lorem-texts__lorem-text'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint earum ex veritatis voluptate eligendi minima maiores necessitatibus. Quae nulla, eos, quasi error ipsa nemo dignissimos voluptas fugit consequatur excepturi placeat.</p>
              <p className='vision-theraforma-lorem-texts__lorem-text'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam error repellendus magnam recusandae nobis repudiandae deleniti, vel consectetur quam dolorem doloremque, atque quisquam reprehenderit dolore laboriosam! Itaque debitis ratione provident!</p>
              <p className='vision-theraforma-lorem-texts__lorem-text'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Et a quos eius expedita fugit corrupti, iure dolorum neque error, sapiente non fuga ut vel repellendus veritatis quidem cupiditate! Eligendi, fugit.</p>
            </div>
          </div>
      </section>
