...
const YearProgram = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className='ellel-year'>
        <div className='ellel-year__h1'>
          <h1>Programme pour l'année 2025</h1>
        </div>
        <p className='ellel-year__p'>Voici un résumé des événements organisés par TheraForma en 2025.</p>
      </div>
            ...
            {category.events.length > 0 ? (
              <ul className="year-program__event-list">
                {category.events.map((event, eventIndex) => (
                  <li key={eventIndex} className="year-program__event-item explore__card" style={{ marginBottom: '10px' }}>
